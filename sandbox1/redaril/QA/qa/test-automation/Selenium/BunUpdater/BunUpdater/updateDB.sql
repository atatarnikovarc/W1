DECLARE CURSOR find_constraints IS SELECT CONSTRAINT_NAME, TABLE_NAME FROM user_constraints WHERE CONSTRAINT_TYPE = 'R';
...
INSERT INTO NC_AUX_CATEGORY SELECT AUX_CATEGORY_ID,NAME,THRESHOLD,SET_ID FROM NC_AUX_CATEGORY@BUN;
