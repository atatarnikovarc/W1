...
folder.
NOTE:(!!)
1. put no spaces after value in property files - i.e. "true " and "true" does matter!!
2. some exclusion phrases make application thinking that change contains exclusion, when
it is actually no(i.e. when adding new exclusion keyword - check how it works)
