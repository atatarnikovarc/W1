...
CREATIVE_ATTRIBUTES = [9] #48 for non ssl
...
class RandomBidGenerator(object):
  ...
  def _GenerateAdSlot(self, bid_request):
    ...
    for creative_attribute in self._GenerateSet(
        CREATIVE_ATTRIBUTES, len(CREATIVE_ATTRIBUTES)):
    ...
    adgroup_array = [11223344, 14993957481, 14993957482]
  ...
  def _GenerateGoogleID(self, bid_request):
    ...
    if self._google_id_list:
      ...
      bid_request.google_user_id = '0000959D00000000000017'
