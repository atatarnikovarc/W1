...
_BIDREQUEST_VIDEO = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='allowed_video_formats', full_name='BidRequest.Video.allowed_video_formats', index=5,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='companion_slot', full_name='BidRequest.Video.companion_slot', index=6,
...
_BIDREQUEST_ADSLOT = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='DEPRECATED_publisher_settings_list_id', full_name='BidRequest.AdSlot.DEPRECATED_publisher_settings_list_id', index=12,
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='slot_visibility', full_name='BidRequest.AdSlot.slot_visibility', index=14,
...
_BIDREQUEST = descriptor.Descriptor(
  ...
  fields=[
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='DEPRECATED_country', full_name='BidRequest.DEPRECATED_country', index=11,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='DEPRECATED_region', full_name='BidRequest.DEPRECATED_region', index=12,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='DEPRECATED_city', full_name='BidRequest.DEPRECATED_city', index=13,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='DEPRECATED_metro', full_name='BidRequest.DEPRECATED_metro', index=14,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='geo_criteria_id', full_name='BidRequest.geo_criteria_id', index=15,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='postal_code', full_name='BidRequest.postal_code', index=16,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='postal_code_prefix', full_name='BidRequest.postal_code_prefix', index=17,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='timezone_offset', full_name='BidRequest.timezone_offset', index=18,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='user_vertical', full_name='BidRequest.user_vertical', index=19,
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='DEPRECATED_seller_network', full_name='BidRequest.DEPRECATED_seller_network', index=21,
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='url', full_name='BidRequest.url', index=23,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='anonymous_id', full_name='BidRequest.anonymous_id', index=24,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='detected_language', full_name='BidRequest.detected_language', index=25,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='detected_vertical', full_name='BidRequest.detected_vertical', index=26,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='vertical_dictionary_version', full_name='BidRequest.vertical_dictionary_version', index=27,
    ...
    descriptor.FieldDescriptor(
      ...
      options=descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')),
    descriptor.FieldDescriptor(
      name='site_list_id', full_name='BidRequest.site_list_id', index=29,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='key_value', full_name='BidRequest.key_value', index=30,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='requires_secure_ads', full_name='BidRequest.requires_secure_ads', index=31,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='mobile', full_name='BidRequest.mobile', index=32,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='video', full_name='BidRequest.video', index=33,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='DEPRECATED_excluded_click_through_url', full_name='BidRequest.DEPRECATED_excluded_click_through_url', index=34,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='DEPRECATED_publisher_settings_list_id', full_name='BidRequest.DEPRECATED_publisher_settings_list_id', index=35,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='publisher_settings_list_id', full_name='BidRequest.publisher_settings_list_id', index=36,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='DEPRECATED_matching_network', full_name='BidRequest.DEPRECATED_matching_network', index=37,
    ...
    descriptor.FieldDescriptor(
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='is_test', full_name='BidRequest.is_test', index=39,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='is_ping', full_name='BidRequest.is_ping', index=40,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='experimental_deadline', full_name='BidRequest.experimental_deadline', index=41,
  ...
  nested_types=[_BIDREQUEST_USERLIST, _BIDREQUEST_VERTICAL, _BIDREQUEST_KEYVALUE, _BIDREQUEST_MOBILE, _BIDREQUEST_VIDEO, _BIDREQUEST_MATCHINGNETWORK, _BIDREQUEST_ADSLOT, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
